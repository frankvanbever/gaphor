...
interactive overview of your entire model — ideal for sharing with stakeholders
or publishing on a static site (GitHub Pages, etc.).
...
![Export menu showing the HTML Report option](images/html-report-export-menu.png)
-->
...
<!-- TODO: add screenshot when available
![Generated HTML report in a browser](images/html-report-output.png)
-->
